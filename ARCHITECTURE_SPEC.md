...
| What the panel is told | The node list, whether the socket is bound, why it is not — and the **counters**: polls sent, replies, unreadable, dropped. Added after the fault above, because *polls going out with nothing coming back*, *nothing being asked at all* and *something arriving and being dropped* are three faults with three remedies and looked identical from the panel |
