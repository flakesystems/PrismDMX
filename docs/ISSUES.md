...
- **Ergebnis:** ➡️ **wurde S57** — acht Punkte, und sie hängen aneinander: welches Fixture gewählt ist, bestimmt den Footprint, der Footprint die nächste freie Adresse, und die nächste freie Adresse ist, was das gleichzeitige Patchen mehrerer braucht. Dazu zwei, die mehr sind als ein Nachmittag — die Bibliothek nach Fixture statt nach Modus gruppieren (der Profilschlüssel einer Show bleibt pro Modus) und beim Scrollen nachladen. Also eine eigene Session statt acht halber Korrekturen, mit Deliverables und Exit-Kriterien in `IMPLEMENTATION_PLAN.md`. Ein Teil ist schon mit B53 besser geworden: die Nummernfelder des Formulars lassen sich jetzt leeren und neu tippen.
