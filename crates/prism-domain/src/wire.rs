...
round_trip! {
    ...
    fixture_beam => crate::FixtureBeam,
    fixture_physical => crate::FixturePhysical,
    geometry_node => crate::GeometryNode,
    beam_shape => crate::BeamShape,
    channel_detail => crate::ChannelDetail,
    channel_function => crate::ChannelFunction,
    channel_set => crate::ChannelSet,
    wheel => crate::Wheel,
    wheel_slot => crate::WheelSlot,
    prism_facet => crate::PrismFacet,
    resource_kind => crate::ResourceKind,
    ...
    switch_position => crate::SwitchPosition,
    switch_state => crate::SwitchState,
    switched_slot => crate::SwitchedSlot,
